# app/api/v1/admin/hospital/block_hospital.py
...
@router.post("/hospitals/{hospital_id}/block", summary="Block hospital (soft)")
def block_hospital(
    hospital_id: str,
    db = Depends(get_db),
