    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-slate-100 to-slate-200 relative">
      ...
      <div className="w-full max-w-md bg-white shadow rounded-xl p-6">
        ...
        <div className="mt-6 border-t pt-5 text-center">
          <p className="text-sm text-slate-600 mb-2">New Doctor? Admin approval required.</p>
          <Link to="/register/doctor" className="px-4 py-2 border rounded-lg text-sm hover:bg-slate-50">
            Register as Doctor
          </Link>
        </div>
      </div>
